...
Based on all the provided goodness-of-fit statistics and criteria (KS statistic, Cramer-von Mises statistic, Anderson-Darling statistic, AIC, and BIC), the gamma distribution fits your data better than the normal distribution. This conclusion is drawn from the fact that all the metrics show lower values for the gamma distribution, indicating a closer match to your observed data.
...
```{r}
combined_plots <- cowplot::plot_grid(group, conditions, age,
                            labels = c("A", "B", "C"),
                            ncol = 2,nrow = 2)
...
```{r}
ggsave("W:/Fmri_Forschung/Allerlei/JuliaS/GitHub/SubliminalVideoPriming/plots/glmm_rt.tiff", combined_plots, width = 6, height = 7)
