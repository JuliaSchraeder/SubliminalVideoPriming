...
%% Full Factorial Design Primer Emotion x Conscious x HC/MDD with RT
...
HC_Subjects = {'sub-010','sub-011','sub-014','sub-015','sub-016','sub-018','sub-019',...
    'sub-022','sub-024','sub-025','sub-027','sub-028','sub-029','sub-030','sub-031','sub-032','sub-033','sub-041',...
...
MDD_Subjects = {'sub-007','sub-008','sub-009','sub-020','sub-035','sub-036','sub-037','sub-038','sub-039',...
    'sub-042','sub-044','sub-048','sub-049','sub-061','sub-064','sub-065','sub-066','sub-072','sub-075','sub-076','sub-077',...
    'sub-081','sub-082','sub-084','sub-087','sub-092','sub-094','sub-095','sub-097','sub-098','sub-100','sub-102',...
    'sub-106','sub-108','sub-109','sub-110','sub-111','sub-113','sub-114','sub-115','sub-116','sub-118',...
...
%% Define Design
matlabbatch{1}.spm.stats.factorial_design.dir = {'/bif/storage/storage1/projects/emocon/SecondLevel/VideoMask/FullFact'};
matlabbatch{1}.spm.stats.factorial_design.des.fd.fact(1).name = 'emotion_target';
...
matlabbatch{1}.spm.stats.factorial_design.des.fd.fact(2).name = 'emotion_prime';
...
matlabbatch{1}.spm.stats.factorial_design.multi_cov.files = {'/bif/storage/storage1/projects/emocon/SecondLevel/VideoMask/rt_regressors.txt'};
...
matlabbatch{2}.spm.stats.fmri_est.spmmat = {'/bif/storage/storage1/projects/emocon/SecondLevel/VideoMask/FullFact_rt/SPM.mat'};
