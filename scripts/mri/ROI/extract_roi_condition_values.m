...
firstlevel = '/bif/storage/storage1/projects/emocon/FirstLevel/VideoMask/';
...
if exist(firstlevel, 'dir') && exist(roi_folder, 'dir')
    firstlevel_path = firstlevel;
    script_folder   = roi_folder;
else
