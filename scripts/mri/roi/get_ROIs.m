...
firstlevel_path = 'C:/Users/jschraeder/Desktop/emocon/FirstLevel/BackwardMask/';  % set to SPM.mat path!!
...
lACC_mask_dir = fullfile(script_folder, 'lACC.nii,1');
rACC_mask_dir = fullfile(script_folder, 'rACC.nii,1');
